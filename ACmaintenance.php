        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 h-100" style="padding-left: 20px;">
                    <div class="card card-inverse">
                        <img class="card-img" src="images/clim.jpg" alt="Card image">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card-block">
                        ...
                        <div class="container">
                            <div class="row" style="background-color: #edebeb; padding-top: 10px;">
                                <div class="col-md-8">
                                    <h6><i class="fas fa-building"></i> Maintenance climatiseur appartement</h6>
                                </div>
                                <div class="col-md-1">
                                ...
                                <div class="col-md-3">
                                    <div class="card text-center" style="margin-bottom: 25px; margin-top: 15px; padding: 15px 10px 10px ">
                                        <div class="card-block">
                                            ...
                                            <p class="card-text">  300dh</p>
                                            <a href="acmaintenance2.php" class="btn btn-primary btn-block"> <strong>Select</strong></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-block">
                        ...
                        <div class="container">
                            <div class="row" style="background-color: #edebeb; padding-top: 10px;">
                                <div class="col-md-8">
                                    <h6><i class="fas fa-home"></i> Maintenance climatiseur Villa</h6>
                                </div>
                                <div class="col-md-1">
