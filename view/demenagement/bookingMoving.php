...
<html lang="en">
    ...
    <body>
        ...
        <div class="top-content" style="padding-top: 2rem;padding-bottom: 2rem;">
            <div class="container">
                <h1  align="center">Demenagement National</h1>
                            ...
                            <fieldset>
                                ...
                                <div class="container"> 
                                    ...
                                    <div class="container"> 
                                        ...
                                        <br>
                                        <hr>
                                        <div class="container"><h5>Avez vous besoin d'un de ces Services ?</h5>
                                            <div class="row">
                                                <div class="col-md-4 ">
                                                    <label class="checkw3">Bricoleur
                                                        <input type="checkbox">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6" ">
                                                        ...
                                                        <img src="../../ressources/images/car.png" height="120px" width="280px">
                                                    </div>
                                                    <div class="col-sm-6 ">
                                                        <div class="checkbox">
                                            ...
                                            <div class="f1-buttons">
                                                ...
                                                <button type="button" class="btn btn-next">Vos DETAILS</button>
                                            </div>
                                        </fieldset>
