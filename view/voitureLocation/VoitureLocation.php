...
<body style="background-image: url('../../ressources/assets/img/voiture.jpg') ; background-repeat:no-repeat;
                        ...
                        <form>
                                ...
                                <div class="tab-pane" id="need">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group label-floating">
                                                    <input type='button' class='btn  btn-fill btn-default btn-wd' name='finish' value='See pictures' />
                            ...
                            <div class="wizard-footer">
                                <div class="pull-right">
                                    ...
                                    <input type='button' class='btn btn-finish btn-fill btn-default btn-wd' name='finish' value='Finish' />
                                </div>
                                <div class="pull-left">
