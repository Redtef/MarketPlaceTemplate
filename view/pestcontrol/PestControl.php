...
<html>
    <head>
        ...
        <style>
            ...
            .bg {
                /* The image used */
                background-image: url("../../ressources/images/icons/pestcontrol.png");
            ...
            .bgm {
                /* The image used */
                background-image: url("../../ressources/images/icons/bgm.jpg");
                ...
                <div class="row">
                    <div class="col-md-3 portfolio-item">
                        <div class="card h-100">
                            <a href="pestcontrol1.php"><img  class="img-thumbnail" alt="Cinque Terre" width="304" height="236" src="../../ressources/images/icons/cockroach1.jpg" > <h4 class="img-thumbnail" style="color: #01748d;">Cockroach Pest Control</h4></a>
                    ...
                    <div class="col-md-3 portfolio-item">
                        <div class="card h-100">
                            <a href="pestcontrol1.php"><img  class="img-thumbnail" alt="Cinque Terre" width="304" height="236" src="../../ressources/images/icons/BedBugs.jpg" > <h4 class="img-thumbnail" style="color: #01748d;">Bed Bugs Pest Control</h4></a>
                            <div class="card-body" style="background-color: #ffffff;">
                                <h4 class="card-title">
                                    <a href="#">Great for:</a>
                                </h4>
                    ...
                    <div class="col-md-3 portfolio-item">
                        <div class="card h-100">
                            <a href="pestcontrol1.php"><img  class="img-thumbnail" alt="Cinque Terre" width="304" height="236" src="../../ressources/images/icons/Ants.jpg" > <h4 class="img-thumbnail" style="color: #01748d;">Ants Pest Control</h4></a>
                            <div class="card-body" style="background-color: #ffffff;">
                                <h4 class="card-title">
                                    <a href="#">Great for:</a>
                                </h4>
                    ...
                    <div class="col-md-3 portfolio-item">
                        <div class="card h-100">
                            <a href="pestcontrol1.php"><img  class="img-thumbnail" alt="Cinque Terre" width="304" height="236" src="../../ressources/images/icons/general.jpg" > <h4 class="img-thumbnail" style="color: #01748d;">General Pest Control</h4></a>
                            <div class="card-body" style="background-color: #ffffff;">
                                <h4 class="card-title">
                                    <a href="#">Great for:</a>
                                </h4>
