        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 h-100" style="padding-left: 20px;">
                    <div class="card card-inverse">
                        <img class="card-img" src="../../ressources/images/icons/booknow.png" alt="Card image">
                ...
                <div class="col-md-8">
                    <h4>Choisissez le pack correspondant à votre cas</h4>
                    <div class="card-block">

                        <div class="container">
                            <div class="row" style="background-color: #edebeb; padding-top: 10px;">
                                <div class="col-md-8">
                                    <h6><i class="fas fa-building"></i>  Pest Control appartement</h6>
                                </div>
                                <div class="col-md-1">
                                ...
                                <div class="col-md-3"> 
                                    <div class="card text-center " style="margin-bottom: 25px; margin-top: 15px; padding: 15px 10px 10px ">
                                        <div class="card-block">
                                            <h4 class="card-title" style="color: #ff5a23;">  1 Unit</h4>
                                            <strong class="card-text" style="color: #00748d;">  300dh</strong><br><br>
                                            <a href="PestControl2.php" class="btn btn-primary btn-block"> <strong>Select</strong></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card text-center" style="margin-bottom: 25px; margin-top: 15px; padding: 15px 10px 10px ">
                                        <div class="card-block">
                                        <h4 class="card-title" style="color: #ff5a23;">  2 Unit</h4>
                                            <strong class="card-text" style="color: #00748d;">  300dh</strong><br><br>
                                            <a href="PestControl2.php" class="btn btn-primary btn-block"> <strong>Select</strong></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card text-center" style="margin-bottom: 25px; margin-top: 15px; padding: 15px 10px 10px ">
                                        <div class="card-block">
                                         <h4 class="card-title" style="color: #ff5a23;">  3 Unit</h4>
                                            <strong class="card-text" style="color: #00748d;">  300dh</strong><br><br>
                                            <a href="PestControl2.php" class="btn btn-primary btn-block"> <strong>Select</strong></a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="card text-center" style="margin-bottom: 25px; margin-top: 15px; padding: 15px 10px 10px ">
                                        <div class="card-block">
                                          <h4 class="card-title" style="color: #ff5a23;">  4 Unit</h4>
                                            <strong class="card-text" style="color: #00748d;">  300dh</strong><br><br>
                                            <a href="PestControl2.php" class="btn btn-primary btn-block"> <strong>Select</strong></a>
                                        </div>
                                    </div>
                    ...
                    <div class="card-block">
                        ...
                        <div class="container">
                            <div class="row" style="background-color: #edebeb; padding-top: 10px;">
                                <div class="col-md-8">
                                    <h6><i class="fas fa-home"></i>  Pest Control  Villa</h6>
                                </div>
                                <div class="col-md-1">
